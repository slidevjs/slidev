...
export async function getIndexHtml({ mode, entry, clientRoot, userRoot, roots, data }: ResolvedSlidevOptions): Promise<string> {
  ...
  for (const root of roots) {
    ...
    if (root === userRoot && index.includes('<!DOCTYPE html>')) {
      console.error(yellow(`[Slidev] Ignored provided index.html with doctype declaration. (${path})`))
