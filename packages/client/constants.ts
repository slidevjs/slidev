...
import type { ClicksFlow, ClicksMaxMap, RenderContext } from '@slidev/types'
...
export const injectionClicksMaxMap: InjectionKey<Ref<ClicksMaxMap>> = Symbol('v-click-clicks-max-map')
