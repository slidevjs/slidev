...
import { draggingFixedElement, magicKeys, showGotoDialog, showOverview, toggleOverview } from '../state'
...
export default function setupShortcuts() {
  ...
  const navViaArrowKeys = and(not(showOverview), not(draggingFixedElement))
