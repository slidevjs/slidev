...
export const community: ThemeInfo[] = [
  ...
  },
  {
    ...
    previews: [
      'https://github.com/nico-bachner/slidev-theme-geist/blob/main/example-export/01.png',
      'https://github.com/nico-bachner/slidev-theme-geist/blob/main/example-export/05.png',
    ],
    tags: [
      'vercel',
      'dark',
