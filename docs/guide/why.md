...
Playing around with Slidev will tell you more than thousands of words. Check the <LinkInline link="guide/why"/> guide to create your first Slidev project in one click or one command.
